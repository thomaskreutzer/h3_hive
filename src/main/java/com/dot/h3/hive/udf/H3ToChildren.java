...
+ "  > SELECT H3ToChildren(617733123174039551, 9) AS children;\n"
+ "  > +----------------------------------------------------+\n"
+ "  > |                      children                      |\n"
+ "  > +----------------------------------------------------+\n"
+ "  > | [617733123174039551,617733123174039551,617733123174039551] |\n"
+ "  > +----------------------------------------------------+\n\n"

+ "Example 2:\n"
+ "  > CREATE TEMPORARY FUNCTION H3ToChildren AS 'com.dot.h3.hive.udf.H3ToChildren';\n"
+ "  > SELECT H3ToChildren('892a100acc7ffff', 9) AS children;"
+ "  > +----------------------------------------------------+\n"
+ "  > |                      children                      |\n"
+ "  > +----------------------------------------------------+\n"
+ "  > | [\"892a100acc7ffff\",\"892a100acc7ffff\",\"892a100acc7ffff\"] |\n"
+ "  > +----------------------------------------------------+\n\n")
