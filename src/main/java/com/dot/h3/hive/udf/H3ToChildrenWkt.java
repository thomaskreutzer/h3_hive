...
+ "  > SELECT H3ToChildrenWkt(617733123174039551, 9) AS children;\n"
+ "  > +----------------------------------------------------+\n"
+ "  > |                      children                      |\n"
+ "  > +----------------------------------------------------+\n"
+ "  > [\"POINT(-73.90212095615803 40.86061876224212)\",\"POINT(-73.90212095615803 40.86061876224212)\",\"POINT(-73.90212095615803 40.86061876224212)\"] |\n"
+ "  > +----------------------------------------------------+\n\n"

+ "Example 2:\n"
+ "  > CREATE TEMPORARY FUNCTION H3ToChildrenWkt AS 'com.dot.h3.hive.udf.H3ToChildrenWkt';\n"
+ "  > SELECT H3ToChildrenWkt('892a100acc7ffff', 9) AS children;"
+ "  > +----------------------------------------------------+\n"
+ "  > |                      children                      |\n"
+ "  > +----------------------------------------------------+\n"
+ "  > | [\"POINT(-73.90212095615803 40.86061876224212)\",\"POINT(-73.90212095615803 40.86061876224212)\",\"POINT(-73.90212095615803 40.86061876224212)\"] |\n"
