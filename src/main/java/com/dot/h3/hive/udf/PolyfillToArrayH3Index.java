...
public class PolyfillToArrayH3Index extends GenericUDF {
	...
	public PolyfillToArrayH3Index() throws H3InstantiationException {
		wkt = new WKT();
		try {
	...
	public Object evaluate(DeferredObject[] arguments) throws HiveException {
		...
		for (int x = 0; x < indexArr.size(); x++) {
			...
			strOut.set( indexArr.get(x).toString() );
			result.add( strOut );
		}
		return result;
	}
	...
	public String getDisplayString(String[] children) {
		return getStandardDisplayString("PolyfillToArrayH3Index", children, ",");
	}
}
